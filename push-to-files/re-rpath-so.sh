...
# It looks like $ORIGIN is the /data/data/app/bin folder, such that $ORIGIN/../lib/ is the library folder ... which I probably can't write to ... but copying the .so's into files/ and setting rpath to $ORIGIN/.. seems to work
